...
var events = allEvents{
	{
		...
		Description: "Learning the basics of Golang via tutorials.",
	},
}
...
func createEvent(w http.ResponseWriter, r *http.Request) {
	...
	//Return the newly created status event
...
func getOneEvent(w http.ResponseWriter, r *http.Request) {
	...
	//Use teh blank identifier to avoid creating a value that will not be used
